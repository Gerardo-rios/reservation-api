...
from src.interactor import GetRoleInputDto, CreateAccountInputDto
...
def test_setup(
    ...
    mocker: mock.Mock,
    fixture_account_data: dict,
    fixture_person_data: dict,
    fixture_role_data: dict,
) -> Dict[str, Any]:
    ...
    mock_account_repository = mocker.patch(
        "src.app.fastapi_mysql.controllers.account_creation_controller.AccountMySQLRepository"
    )
    mock_role_presenter = mocker.patch(
        "src.app.fastapi_mysql.controllers.account_creation_controller.GetRolePresenter"
    )
    mock_account_presenter = mocker.patch(
        "src.app.fastapi_mysql.controllers.account_creation_controller.CreateAccountPresenter"
    )
    mock_get_role_use_case = mocker.patch(
        "src.app.fastapi_mysql.controllers.account_creation_controller.GetRoleUseCase"
    )
